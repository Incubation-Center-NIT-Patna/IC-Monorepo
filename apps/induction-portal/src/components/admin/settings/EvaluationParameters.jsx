    ...
    <section className="w-full">
      ...
      <div className="flex items-center justify-between mb-3 px-1">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-[15px] font-semibold text-white tracking-wide">Evaluation Parameters</h2>
        </div>
        
        <button 
          type="button" 
          onClick={handleAddParameter} 
          className="text-xs font-semibold text-[#10B981] hover:text-[#059669] transition-colors focus:outline-none"
        >
          + Add
        </button>
      </div>
      ...
      <div className="bg-[#111C2A]/60 border border-[#1E293B] rounded-xl p-3 space-y-3 w-full">
        {parameters.length === 0 ? (
