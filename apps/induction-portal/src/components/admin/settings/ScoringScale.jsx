  ...
  return (
    <section className="mb-6 w-full">
      ...
      <div className="flex items-center gap-2 mb-4 px-1">
        ...
        <h2 className="text-lg font-semibold text-white tracking-wide">Scoring Scale</h2>
      </div>

     
      <div className="bg-[#111C2A]/60 border border-[#1E293B] rounded-xl p-4 md:p-6 w-full">
        <div className="grid grid-cols-2 gap-4 mb-4">
          
          {/* Minimum Input Controller Field */}
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Minimum Score</label>
            <input
              type="number"
              value={minScore}
              onChange={(e) => setMinScore(Number(e.target.value))}
              className="bg-[#070D19] border border-gray-800 rounded-xl px-4 py-3 text-sm font-medium text-white focus:border-[#10B981] outline-none transition-all w-full"
            />
          </div>
          
          {/* Maximum Input Controller Field */}
          <div className="flex flex-col gap-2">
            <label className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Maximum Score</label>
            <input
              type="number"
              value={maxScore}
        ...
        <div className="text-center text-xs text-gray-400 mt-4 border-t border-gray-800/60 pt-3">
