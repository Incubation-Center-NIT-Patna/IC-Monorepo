  ...
  return (
    <nav className="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-15 bg-[#111319]">
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        ...
        <div className="rounded-full border border-[#859490] overflow-hidden cursor-pointer shrink-0 w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center hover:opacity-90 transition-opacity bg-black/40 p-0.5">
          <Image src="/ic_logo.webp" alt="IC Logo" height={36} width={36} priority />
        </div>
      </div>
    </nav>
  );
