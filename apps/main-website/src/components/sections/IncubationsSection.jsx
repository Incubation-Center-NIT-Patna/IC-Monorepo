  ...
  return (
    <section id="incubations" className="site-section">
      ...
      <div className="site-container">
        ...
        <div className="incubation-swiper-pagination !relative !bottom-auto !left-auto !transform-none flex justify-center items-center gap-3 mt-5 mb-2 bg-transparent border-none shadow-none [&_.swiper-pagination-bullet]:!inline-block [&_.swiper-pagination-bullet]:!w-2.5 [&_.swiper-pagination-bullet]:!h-2.5 [&_.swiper-pagination-bullet]:!rounded-full [&_.swiper-pagination-bullet]:!bg-transparent [&_.swiper-pagination-bullet]:!border-none [&_.swiper-pagination-bullet]:!opacity-0 [&_.swiper-pagination-bullet]:!transition-all [&_.swiper-pagination-bullet]:!duration-300 [&_.swiper-pagination-bullet-active]:!bg-[#0ef] [&_.swiper-pagination-bullet-active]:!opacity-100 [&_.swiper-pagination-bullet-active]:shadow-[0_0_12px_#0ef]" />
      </div>
